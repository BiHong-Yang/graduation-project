      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            <li role="presentation" id="navMenu" class="active">
              <a href="#">nav</a>
            </li>
            <li role="presentation" id="formMenu" class="active">
              <a href="#">form</a>
            </li>
            <li role="presentation" id="mapMenu" class="active">
              <a href="#">map</a>
            </li>
            <li role="presentation" id="utilsMenu" class="active">
              <a href="#">utils</a>
            </li>
          </ul>
        </div>
...
$.ui.plugin.add("resizable", "alsoResizeReverse", {
  start: function(event, ui) {
    ...
    if (
      typeof o.alsoResizeReverse == "object" &&
